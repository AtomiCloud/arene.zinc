...
)
{
  ...
  {
    using (webapp.Logger.BeginScope(new List<KeyValuePair<string, object>>
           {
    ...
    if (errorPortal.CurrentValue.EnableExceptionResponse) webapp.UseDeveloperExceptionPage();
