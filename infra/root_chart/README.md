...
| bromine.rootSecret | object | `{"name":"zinc","ref":{"clientId":"ARENE_ZINCCLIENT_ID","clientSecret":"ARENE_ZINCCLIENT_SECRET"}}` | Secret of Secrets reference |
| bromine.rootSecret.ref | object | `{"clientId":"ARENE_ZINCCLIENT_ID","clientSecret":"ARENE_ZINCCLIENT_SECRET"}` | Infisical Token Reference |
| bromine.rootSecret.ref.clientId | string | `"ARENE_ZINCCLIENT_ID"` | Client ID |
| bromine.rootSecret.ref.clientSecret | string | `"ARENE_ZINCCLIENT_SECRET"` | Client Secret |
...
| maindb.auth.database | string | `"arene-zinc"` |  |
...
| mainstorage.apiIngress.hostname | string | `"mainstorage.zinc.arene.lapras.lvh.me"` |  |
...
| mainstorage.ingress.hostname | string | `"console-mainstorage.zinc.arene.lapras.lvh.me"` |  |
